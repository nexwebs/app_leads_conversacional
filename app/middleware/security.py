...
public_rate_limiter = InMemoryRateLimiter(requests_per_minute=10, requests_per_hour=100)

auth_rate_limiter = InMemoryRateLimiter(requests_per_minute=5, requests_per_hour=20)
